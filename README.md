...
* <span id="ai">AI 🤖</span>
  ...
  * <span id="ai-dev-tools">개발 도구</span>
    * [Agent QA <sub>EN, F, O</sub>](https://github.com/vostride/agent-qa) ⭐ 934 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-03 - 자연어로 웹·모바일 테스트를 실행하고, 메모리로 학습하며 실패를 스스로 복구하는 오픈소스 QA 에이전트
  ...
  * <span id="ai-local-tools">로컬 AI 도구</span>
    * [PrivateGPT <sub>F, O</sub>](https://github.com/imartinez/privateGPT) ⭐ 57,451 | 🐛 5 | 🌐 Python | 📅 2026-08-21 - 로컬 환경에서 문서와 상호작용할 수 있는 프라이버시 중심의 AI 솔루션
    * [LocalAI <sub>F, O</sub>](https://github.com/go-skynet/LocalAI) ⭐ 48,613 | 🐛 197 | 🌐 Go | 📅 2026-08-22 - OpenAI API와 호환되는 로컬 REST API를 제공하는 자체 호스팅 가능한 오픈소스 솔루션
    * [DSH Studio <sub>EN, F, O</sub>](https://github.com/Moresyl/dsh-studio) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-08-22 - DeepSeek Harness를 로컬에서 설치·실행·감독하는 오픈소스 크로스플랫폼 데스크톱 앱
...
* <span id="collection-of-data">자료모음 🧾</span>
  ...
  * <span id="awesome">Awesome</span>
    * [Awesome <sub>EN, O</sub>](https://github.com/sindresorhus/awesome) ⭐ 498,687 | 🐛 105 | 📅 2026-08-21 - 프로그래밍 관련 자료모음
    * [Awesome Computer Science <sub>EN</sub>](https://github.com/ossu/computer-science) ⭐ 208,306 | 🐛 25 | 🌐 HTML | 📅 2026-07-14 - 컴퓨터 사이언스 자료모음 (Awesome 계열)
    * [Awesome Mcp Servers <sub>EN, O</sub>](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 92,667 | 🐛 3,313 | 📅 2026-08-17 - MCP Server 관련 자료모음 (Awesome 계열)
    ...
    * [Awesome Vue <sub>EN, O</sub>](https://github.com/vuejs/awesome-vue) ⭐ 73,542 | 🐛 98 | 📅 2026-07-24 - Vue.js 관련 자료모음 (Awesome 계열)
    * [Awesome C++ <sub>EN, O</sub>](https://github.com/fffaraz/awesome-cpp) ⭐ 72,869 | 🐛 312 | 📅 2026-08-19 - C++ 관련 자료모음 (Awesome 계열)
    * [Awesome Courses <sub>EN</sub>](https://github.com/prakhar1989/awesome-courses) ⭐ 70,580 | 🐛 64 | 📅 2023-05-04 - 무료 CS 강좌 모음 (Awesome 계열)
    * [Awesome Node.js <sub>EN, O</sub>](https://github.com/sindresorhus/awesome-nodejs) ⭐ 66,587 | 🐛 26 | 📅 2026-05-03 - Node.js 관련 자료모음 (Awesome 계열)
    * [Awesome Docker <sub>EN</sub>](https://github.com/veggiemonk/awesome-docker) ⭐ 36,682 | 🐛 15 | 📅 2026-08-19 - 도커 자료모음 (Awesome 계열)
    * [Awesome Data Science <sub>EN</sub>](https://github.com/academic/awesome-datascience) ⭐ 29,850 | 🐛 9 | 📅 2026-08-18 - 데이터 사이언스 자료모음 (Awesome 계열)
    * [Awesome Deep Learning <sub>EN</sub>](https://github.com/ChristosChristofidis/awesome-deep-learning) ⭐ 28,790 | 🐛 84 | 📅 2025-05-26 - 딥 러닝 자료모음 (Awesome 계열)
    * [Awesome Computer Vision <sub>EN</sub>](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,510 | 🐛 91 | 📅 2024-05-17 - 컴퓨터 비전 자료모음 (Awesome 계열)
    ...
    * [Awesome Tailwind CSS <sub>EN, O</sub>](https://github.com/aniftyco/awesome-tailwindcss) ⭐ 15,157 | 🐛 0 | 📅 2026-08-14 - Tailwind CSS 관련 자료모음 (Awesome 계열)
    * [Awesome Microservices <sub>EN</sub>](https://github.com/mfornos/awesome-microservices) ⭐ 14,489 | 🐛 8 | 📅 2026-08-20 - 마이크로서비스 자료모음 (Awesome 계열)
    * [Awesome Ruby <sub>EN, O</sub>](https://github.com/markets/awesome-ruby) ⭐ 14,141 | 🐛 8 | 📅 2026-08-13 - Ruby 관련 자료모음 (Awesome 계열)
    * [Awesome Generative AI <sub>EN</sub>](https://github.com/steven2358/awesome-generative-ai) ⭐ 12,525 | 🐛 591 | 📅 2026-08-03 - 생성형 AI 자료모음 (Awesome 계열)
    * [Awesome Next.js <sub>EN, O</sub>](https://github.com/unicodeveloper/awesome-nextjs) ⭐ 11,109 | 🐛 255 | 📅 2026-07-29 - Next.js 관련 자료모음 (Awesome 계열)
    * [Awesome Angular <sub>EN, O</sub>](https://github.com/PatrickJS/awesome-angular) ⭐ 10,062 | 🐛 1 | 🌐 HTML | 📅 2026-08-21 - Angular 관련 자료모음 (Awesome 계열)
    ...
    * [Awesome Fonts <sub>EN, O</sub>](https://github.com/brabadu/awesome-fonts) ⭐ 2,053 | 🐛 9 | 📅 2026-07-26 - 폰트 관련 자료모음 (Awesome 계열)
    * [Algovis <sub>EN, O</sub>](https://github.com/enjalot/algovis) ⭐ 1,765 | 🐛 8 | 📅 2022-12-05 - 알고리즘 시각화 자료모음 (Awesome 계열)
    * [Awesome Playwright <sub>EN</sub>](https://github.com/mxschmitt/awesome-playwright) ⭐ 1,560 | 🐛 5 | 📅 2026-08-12 - 플레이라이트 자료모음 (Awesome 계열)
    * [Awesome Web Icons <sub>EN, O</sub>](https://github.com/vkarampinis/awesome-icons) ⭐ 1,554 | 🐛 2 | 📅 2026-08-11 - 웹 아이콘 관련 자료모음 (Awesome 계열)
    ...
    * [Awesome Icons <sub>EN, O</sub>](https://github.com/notlmn/awesome-icons) ⭐ 992 | 🐛 9 | 📅 2026-07-19 - 아이콘 관련 자료모음 (Awesome 계열)
    ...
    * [Awesome CodeRabbit <sub>EN</sub>](https://github.com/coderabbitai/awesome-coderabbit) ⭐ 483 | 🐛 13 | 📅 2026-06-25 - 코드래빗 자료모음 (Awesome 계열)
